This folder contains the files needed to replicate training run 1 

This is the basic training run for the Random forest model using the 2019 yellow taxis dataset without the weather data.
...
PKl file for Train 1 

https://drive.google.com/file/d/14yqlHRT46hZ1_hGEzPYlSCQwitaKL389/view?usp=sharing
