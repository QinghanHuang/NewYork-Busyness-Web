This folder contains the files needed to replicate training run 4 

This is the forth training run for the Random forest model using the 2019 yellow taxis dataset without the weather data. It is similar to training run 1 but has a few features that were removed after reading the feature importances docs in order to study the effect of removing features of low importance in random forest models.
...
PKl file for Train 4

https://drive.google.com/file/d/1rz92h-8CHiCjNI-PbmLrrECc567nbLBF/view?usp=sharing
...
https://drive.google.com/file/d/1ddIqGHlBVtfZWRBOTJC5jwO6bx9efcOj/view?usp=sharing
...
(4) feature_complete4_3 - further cleaning and encoding the features.
...
https://drive.google.com/file/d/1mCNGUvutTOIXQPdj3e1NKX4MI2ETQU5G/view?usp=sharing
